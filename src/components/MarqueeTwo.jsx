...
const MarqueeTwo = () => {
    ...
    useEffect(() => {
        ...
        gsap.to('.header__marq-wrapp-two', {
            scrollTrigger: {
                trigger: '.header__marq-two',
                start: 'top bottom',
    ...
    return (
        <div className='header__marq-two' ref={marqueeRef}>
            <div className="header__marq-wrapp-two">
                {Array(4).fill().map((_, index) => (
                    <span className="header__marq-txt" key={index}>
                        <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 464.53 155.93" fill="#fff" width={450} style={{padding: '2rem 0 0 0'}}>
